    ...
    {      
        public class SocialMedia
        {
            ...
            public static void TestAll()
            {
                ...
                Console.WriteLine("Initiate user 1: " + InitUser("125", "Ephemeral", "Rift", "1122@gmail.com", temp1, temp2));

                Console.WriteLine("Login user: " + UserLogin("125", "CHANGE_ME"));

                Console.WriteLine("Initiate user 2: " + InitUser("176", "Joe", "Mangold", "toad@gmail.com", temp3, temp4));

                Console.WriteLine("Initiate user 3: " + InitUser("123", "Craig", "Dudeface", "brad798@gmail.com", temp3, temp4));

                Console.WriteLine("Initiate user 4: " + InitUser("321", "Billy", "Bronson", "hardy@gmail.com", temp3, temp4));

                Console.WriteLine("Initiate post 1: " + InitPost("this is a test post", "Joe", "125"));

                Console.WriteLine("Initiate post 2: " + InitPost("this is another test post hahah", "Ephemeral", "176"));

                Console.WriteLine("Initiate post 3: " + InitPost("tested again", "Craig", "125"));

                Console.WriteLine("Friend users: " + AddFriend("123", "125"));
                Console.WriteLine("Friend users: " + AddFriend("123", "321"));

                Console.WriteLine("Delete friend: " + DeleteFriend("123", "125"));

                Console.WriteLine("Delete Post: " + DeletePost(1, "125"));

                Console.WriteLine("Delete User: " + DeleteUser("176"));

                Console.WriteLine("Enter to continue test");
                Console.ReadLine();

                Console.WriteLine("Export system data: " + ExportData());
                Console.WriteLine("Enter to continue test");
                Console.ReadLine();

                Console.WriteLine("Reset system: " + ResetSystem());
                Console.WriteLine("Enter to continue test");
                Console.ReadLine();

                Console.WriteLine("Import data: " + ImportData());
                Console.ReadLine();

                Console.WriteLine("Retrieve friends: " + string.Join(",", GetFriends("123").ToArray()));
                Console.WriteLine("Retrieve friends posts: " + string.Join(",", GetFriendPosts("123").ToArray()));
                Console.WriteLine("\nTest Complete.");
                Console.ReadLine();
            }            
        }
